...
$RootMenu->AddMenuItem(3, "mmi_t03_kelas", $Language->MenuPhrase("3", "MenuText"), "t03_kelaslist.php?cmd=resetall", -1, "", TRUE, FALSE, FALSE);
$RootMenu->AddMenuItem(4, "mmi_t04_siswa", $Language->MenuPhrase("4", "MenuText"), "t04_siswalist.php?cmd=resetall", -1, "", TRUE, FALSE, FALSE);
