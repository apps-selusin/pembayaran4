...
function Database_Connecting(&$info) {
	...
	if (ew_CurrentUserIP () == "127.0.0.1"  || ew_CurrentUserIP () == ":: 1"  || ew_CurrentHost () == "localhost" ) { // testing on local PC
		...
		$info["port"] = "3307";
	} elseif (ew_CurrentHost () == "pembayaran4.nma-indonesia.com") { // setting koneksi database untuk komputer server
		...
		$info["db"] = "u945388674_pemb4"; // sesuaikan dengan nama database di komputer server
		$info["port"] = "3306";
	}
}
