...
class crv04_uang_masuk extends crTableBase {
	...
	function SetupLookupFilters($fld) {
		...
		case "x_NIS":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `NIS`, `NIS` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		...
		case "x_Nama":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Nama`, `Nama` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		...
		case "x_Jenis":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Jenis`, `Jenis` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		...
		case "x_Kelas":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Kelas`, `Kelas` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		...
		case "x_Sekolah":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Sekolah`, `Sekolah` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		...
		$sSqlWrk .= " ORDER BY `Sekolah` ASC";
			if ($sSqlWrk <> "")
				$fld->LookupFilters["s"] .= $sSqlWrk;
			break;
		case "x_Per_Thn_Bln_Byr_Text":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Per_Thn_Bln_Byr_Text`, `Per_Thn_Bln_Byr_Text` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v04_uang_masuk`";
		$sWhereWrk = "";
		$this->Per_Thn_Bln_Byr_Text->LookupFilters = array();
			$fld->LookupFilters += array("s" => $sSqlWrk, "d" => "DB", "f0" => '`Per_Thn_Bln_Byr_Text` = {filter_value}', "t0" => "200", "fn0" => "", "dlm" => ewr_Encrypt($fld->FldDelimiter));
			$sSqlWrk = "";
		$this->Lookup_Selecting($this->Per_Thn_Bln_Byr_Text, $sWhereWrk); // Call Lookup selecting
		if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
		$sSqlWrk .= " ORDER BY `Per_Thn_Bln_Byr_Text` ASC";
			if ($sSqlWrk <> "")
				$fld->LookupFilters["s"] .= $sSqlWrk;
			break;
		}
