...
$t03_kelas_grid = NULL; // Initialize page object first

class ct03_kelas_grid extends ct03_kelas {
	...
	// Page object name
	var $PageObjName = 't03_kelas_grid';

	// Grid form hidden field names
	var $FormName = 'ft03_kelasgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t03_kelas"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t02_sekolah") {
			...
			if ($GLOBALS["t02_sekolah"]->EventCancelled) $this->EventCancelled = TRUE;
		}
