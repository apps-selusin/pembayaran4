...
<?php include_once "v05_potensirptinfo.php" ?>
<?php
...
$v05_potensi_rpt = NULL; // Initialize page object first

class crv05_potensi_rpt extends crv05_potensi {
	...
	// Page object name
	var $PageObjName = 'v05_potensi_rpt';
	...
	function __construct() {
		...
		// Table object (v05_potensi)
		if (!isset($GLOBALS["v05_potensi"])) {
			$GLOBALS["v05_potensi"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["v05_potensi"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'v05_potensi', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fv05_potensirpt";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_v05_potensi\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_v05_potensi',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fv05_potensirpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fv05_potensirpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fv05_potensirpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['Name_exp_12'] = ewr_Conv($rs->fields('Name_exp_12'), 200);
				$this->FirstRowData['Name_exp_13'] = ewr_Conv($rs->fields('Name_exp_13'), 200);
				$this->FirstRowData['Bayar'] = ewr_Conv($rs->fields('Bayar'), 4);
				$this->FirstRowData['Name_exp_15'] = ewr_Conv($rs->fields('Name_exp_15'), 200);
				$this->FirstRowData['Name_exp_16'] = ewr_Conv($rs->fields('Name_exp_16'), 200);
		} else { // Get next row
			$rs->MoveNext();
		}
		if (!$rs->EOF) {
			...
			$this->Name_exp_12->setDbValue($rs->fields('Name_exp_12'));
			$this->Name_exp_13->setDbValue($rs->fields('Name_exp_13'));
			$this->Bayar->setDbValue($rs->fields('Bayar'));
			$this->Name_exp_15->setDbValue($rs->fields('Name_exp_15'));
			$this->Name_exp_16->setDbValue($rs->fields('Name_exp_16'));
			...
			$this->Name_exp_12->setDbValue("");
			$this->Name_exp_13->setDbValue("");
			$this->Bayar->setDbValue("");
			$this->Name_exp_15->setDbValue("");
			$this->Name_exp_16->setDbValue("");
		}
	}
	...
	function GetExtendedFilter() {
		...
		// Reset search command
			...
			if ($this->GetDropDownValue($this->NIS)) {
				$bSetupFilter = TRUE;
			} elseif ($this->NIS->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_v05_potensi_NIS'])) {
				$bSetupFilter = TRUE;
			}
			...
			if ($this->GetDropDownValue($this->Nama)) {
				$bSetupFilter = TRUE;
			} elseif ($this->Nama->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_v05_potensi_Nama'])) {
				$bSetupFilter = TRUE;
			}
			...
			if ($this->GetDropDownValue($this->Jenis)) {
				$bSetupFilter = TRUE;
			} elseif ($this->Jenis->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_v05_potensi_Jenis'])) {
				$bSetupFilter = TRUE;
			}
			...
			if ($this->GetDropDownValue($this->Kelas)) {
				$bSetupFilter = TRUE;
			} elseif ($this->Kelas->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_v05_potensi_Kelas'])) {
				$bSetupFilter = TRUE;
			}
			...
			if ($this->GetDropDownValue($this->Sekolah)) {
				$bSetupFilter = TRUE;
			} elseif ($this->Sekolah->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_v05_potensi_Sekolah'])) {
				$bSetupFilter = TRUE;
			}
	...
	function GetSessionDropDownValue(&$fld) {
		$parm = substr($fld->FldVar, 2);
		$this->GetSessionValue($fld->DropDownValue, 'sv_v05_potensi_' . $parm);
		$this->GetSessionValue($fld->SearchOperator, 'so_v05_potensi_' . $parm);
	}

	// Get filter values from session
	function GetSessionFilterValues(&$fld) {
		$parm = substr($fld->FldVar, 2);
		$this->GetSessionValue($fld->SearchValue, 'sv_v05_potensi_' . $parm);
		$this->GetSessionValue($fld->SearchOperator, 'so_v05_potensi_' . $parm);
		$this->GetSessionValue($fld->SearchCondition, 'sc_v05_potensi_' . $parm);
		$this->GetSessionValue($fld->SearchValue2, 'sv2_v05_potensi_' . $parm);
		$this->GetSessionValue($fld->SearchOperator2, 'so2_v05_potensi_' . $parm);
	}
	...
	function SetSessionDropDownValue($sv, $so, $parm) {
		$_SESSION['sv_v05_potensi_' . $parm] = $sv;
		$_SESSION['so_v05_potensi_' . $parm] = $so;
	}

	// Set filter values to session
	function SetSessionFilterValues($sv1, $so1, $sc, $sv2, $so2, $parm) {
		$_SESSION['sv_v05_potensi_' . $parm] = $sv1;
		$_SESSION['so_v05_potensi_' . $parm] = $so1;
		$_SESSION['sc_v05_potensi_' . $parm] = $sc;
		$_SESSION['sv2_v05_potensi_' . $parm] = $sv2;
		$_SESSION['so2_v05_potensi_' . $parm] = $so2;
	}
	...
	function ClearSessionSelection($parm) {
		$_SESSION["sel_v05_potensi_$parm"] = "";
		$_SESSION["rf_v05_potensi_$parm"] = "";
		$_SESSION["rt_v05_potensi_$parm"] = "";
	}

	// Load selection from session
	function LoadSelectionFromSession($parm) {
		$fld = &$this->FieldByParm($parm);
		$fld->SelectionList = @$_SESSION["sel_v05_potensi_$parm"];
		$fld->RangeFrom = @$_SESSION["rf_v05_potensi_$parm"];
		$fld->RangeTo = @$_SESSION["rt_v05_potensi_$parm"];
	}
...
// Create page object
if (!isset($v05_potensi_rpt)) $v05_potensi_rpt = new crv05_potensi_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$v05_potensi_rpt;
...
// Create page object
var v05_potensi_rpt = new ewr_Page("v05_potensi_rpt");

// Page properties
v05_potensi_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = v05_potensi_rpt.PageID;

// Extend page with Chart_Rendering function
v05_potensi_rpt.Chart_Rendering = 
...
v05_potensi_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
// Form object
var CurrentForm = fv05_potensirpt = new ewr_Form("fv05_potensirpt");

// Validate method
fv05_potensirpt.Validate = function() {
...
fv05_potensirpt.Form_CustomValidate = 
...
fv05_potensirpt.ValidateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fv05_potensirpt.ValidateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
fv05_potensirpt.Lists["sv_NIS"] = {"LinkField":"sv_NIS","Ajax":true,"DisplayFields":["sv_NIS","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
fv05_potensirpt.Lists["sv_Nama"] = {"LinkField":"sv_Nama","Ajax":true,"DisplayFields":["sv_Nama","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
fv05_potensirpt.Lists["sv_Jenis"] = {"LinkField":"sv_Jenis","Ajax":true,"DisplayFields":["sv_Jenis","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
fv05_potensirpt.Lists["sv_Kelas"] = {"LinkField":"sv_Kelas","Ajax":true,"DisplayFields":["sv_Kelas","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
fv05_potensirpt.Lists["sv_Sekolah"] = {"LinkField":"sv_Sekolah","Ajax":true,"DisplayFields":["sv_Sekolah","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<script type="text/javascript">
...
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<!-- Search form (begin) -->
<form name="fv05_potensirpt" id="fv05_potensirpt" class="form-inline ewForm ewExtFilterForm" action="<?php echo ewr_CurrentPage() ?>">
<?php $SearchPanelClass = ($Page->Filter <> "") ? " in" : " in"; ?>
<div id="fv05_potensirpt_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
...
<select data-table="v05_potensi" data-field="x_NIS" data-value-separator="<?php echo ewr_HtmlEncode(is_array($Page->NIS->DisplayValueSeparator) ? json_encode($Page->NIS->DisplayValueSeparator) : $Page->NIS->DisplayValueSeparator) ?>" id="sv_NIS" name="sv_NIS"<?php echo $Page->NIS->EditAttributes() ?>>
...
<select data-table="v05_potensi" data-field="x_Nama" data-value-separator="<?php echo ewr_HtmlEncode(is_array($Page->Nama->DisplayValueSeparator) ? json_encode($Page->Nama->DisplayValueSeparator) : $Page->Nama->DisplayValueSeparator) ?>" id="sv_Nama" name="sv_Nama"<?php echo $Page->Nama->EditAttributes() ?>>
<option value=""><?php echo $ReportLanguage->Phrase("PleaseSelect") ?></option>
<?php
...
<select data-table="v05_potensi" data-field="x_Jenis" data-value-separator="<?php echo ewr_HtmlEncode(is_array($Page->Jenis->DisplayValueSeparator) ? json_encode($Page->Jenis->DisplayValueSeparator) : $Page->Jenis->DisplayValueSeparator) ?>" id="sv_Jenis" name="sv_Jenis"<?php echo $Page->Jenis->EditAttributes() ?>>
<option value=""><?php echo $ReportLanguage->Phrase("PleaseSelect") ?></option>
<?php
...
<select data-table="v05_potensi" data-field="x_Kelas" data-value-separator="<?php echo ewr_HtmlEncode(is_array($Page->Kelas->DisplayValueSeparator) ? json_encode($Page->Kelas->DisplayValueSeparator) : $Page->Kelas->DisplayValueSeparator) ?>" id="sv_Kelas" name="sv_Kelas"<?php echo $Page->Kelas->EditAttributes() ?>>
<option value=""><?php echo $ReportLanguage->Phrase("PleaseSelect") ?></option>
<?php
...
<select data-table="v05_potensi" data-field="x_Sekolah" data-value-separator="<?php echo ewr_HtmlEncode(is_array($Page->Sekolah->DisplayValueSeparator) ? json_encode($Page->Sekolah->DisplayValueSeparator) : $Page->Sekolah->DisplayValueSeparator) ?>" id="sv_Sekolah" name="sv_Sekolah"<?php echo $Page->Sekolah->EditAttributes() ?>>
<option value=""><?php echo $ReportLanguage->Phrase("PleaseSelect") ?></option>
<?php
...
<script type="text/javascript">
fv05_potensirpt.Init();
fv05_potensirpt.FilterList = <?php echo $Page->GetFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="NIS"><div class="v05_potensi_NIS"><span class="ewTableHeaderCaption"><?php echo $Page->NIS->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="NIS">
<?php if ($Page->SortUrl($Page->NIS) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_NIS">
			<span class="ewTableHeaderCaption"><?php echo $Page->NIS->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_NIS" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->NIS) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->NIS->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Nama"><div class="v05_potensi_Nama"><span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Nama">
<?php if ($Page->SortUrl($Page->Nama) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_Nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_Nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Jenis"><div class="v05_potensi_Jenis"><span class="ewTableHeaderCaption"><?php echo $Page->Jenis->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Jenis">
<?php if ($Page->SortUrl($Page->Jenis) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_Jenis">
			<span class="ewTableHeaderCaption"><?php echo $Page->Jenis->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_Jenis" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Jenis) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Jenis->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Nilai"><div class="v05_potensi_Nilai"><span class="ewTableHeaderCaption"><?php echo $Page->Nilai->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Nilai">
<?php if ($Page->SortUrl($Page->Nilai) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_Nilai">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nilai->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_Nilai" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Nilai) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nilai->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Kelas"><div class="v05_potensi_Kelas"><span class="ewTableHeaderCaption"><?php echo $Page->Kelas->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Kelas">
<?php if ($Page->SortUrl($Page->Kelas) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_Kelas">
			<span class="ewTableHeaderCaption"><?php echo $Page->Kelas->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_Kelas" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Kelas) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Kelas->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Sekolah"><div class="v05_potensi_Sekolah"><span class="ewTableHeaderCaption"><?php echo $Page->Sekolah->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Sekolah">
<?php if ($Page->SortUrl($Page->Sekolah) == "") { ?>
		<div class="ewTableHeaderBtn v05_potensi_Sekolah">
			<span class="ewTableHeaderCaption"><?php echo $Page->Sekolah->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer v05_potensi_Sekolah" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Sekolah) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Sekolah->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_NIS"<?php echo $Page->NIS->ViewAttributes() ?>><?php echo $Page->NIS->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Nama->Visible) { ?>
		<td data-field="Nama"<?php echo $Page->Nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_Nama"<?php echo $Page->Nama->ViewAttributes() ?>><?php echo $Page->Nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Jenis->Visible) { ?>
		<td data-field="Jenis"<?php echo $Page->Jenis->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_Jenis"<?php echo $Page->Jenis->ViewAttributes() ?>><?php echo $Page->Jenis->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Nilai->Visible) { ?>
		<td data-field="Nilai"<?php echo $Page->Nilai->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_Nilai"<?php echo $Page->Nilai->ViewAttributes() ?>><?php echo $Page->Nilai->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Kelas->Visible) { ?>
		<td data-field="Kelas"<?php echo $Page->Kelas->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_Kelas"<?php echo $Page->Kelas->ViewAttributes() ?>><?php echo $Page->Kelas->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Sekolah->Visible) { ?>
		<td data-field="Sekolah"<?php echo $Page->Sekolah->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_v05_potensi_Sekolah"<?php echo $Page->Sekolah->ViewAttributes() ?>><?php echo $Page->Sekolah->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "v05_potensirptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
