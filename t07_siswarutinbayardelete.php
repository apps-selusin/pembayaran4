...
<?php if ($t07_siswarutinbayar->Periode->Visible) { // Periode ?>
		<th><span id="elh_t07_siswarutinbayar_Periode" class="t07_siswarutinbayar_Periode"><?php echo $t07_siswarutinbayar->Periode->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($t07_siswarutinbayar->Periode->Visible) { // Periode ?>
		<td<?php echo $t07_siswarutinbayar->Periode->CellAttributes() ?>>
<span id="el<?php echo $t07_siswarutinbayar_delete->RowCnt ?>_t07_siswarutinbayar_Periode" class="t07_siswarutinbayar_Periode">
