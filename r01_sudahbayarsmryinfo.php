...
//
// Table class for r01_sudahbayar
//
class crr01_sudahbayar extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r01_sudahbayar';
		$this->TableName = 'r01_sudahbayar';
		...
		// siswarutin_id
		$this->siswarutin_id = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_siswarutin_id', 'siswarutin_id', '`siswarutin_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// siswa_id
		$this->siswa_id = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_siswa_id', 'siswa_id', '`siswa_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// rutin_id
		$this->rutin_id = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_rutin_id', 'rutin_id', '`rutin_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// sekolah_id
		$this->sekolah_id = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// kelas_id
		$this->kelas_id = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_kelas_id', 'kelas_id', '`kelas_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// NIS
		$this->NIS = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_NIS', 'NIS', '`NIS`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Nama
		$this->Nama = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Nama', 'Nama', '`Nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Kelas
		$this->Kelas = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Kelas', 'Kelas', '`Kelas`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Sekolah
		$this->Sekolah = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Sekolah', 'Sekolah', '`Sekolah`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Periode_Tahun_Bulan
		$this->Periode_Tahun_Bulan = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Periode_Tahun_Bulan', 'Periode_Tahun_Bulan', '`Periode_Tahun_Bulan`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Periode_Text
		$this->Periode_Text = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Periode_Text', 'Periode_Text', '`Periode_Text`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Jenis
		$this->Jenis = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Jenis', 'Jenis', '`Jenis`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Nilai
		$this->Nilai = new crField('r01_sudahbayar', 'r01_sudahbayar', 'x_Nilai', 'Nilai', '`Nilai`', 4, EWR_DATATYPE_NUMBER, -1);
	...
	function SetupLookupFilters($fld) {
		...
		case "x_NIS":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `NIS`, `NIS` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v02_siswa`";
		$sWhereWrk = "";
		...
		case "x_Nama":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Nama`, `Nama` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v02_siswa`";
		$sWhereWrk = "";
		...
		case "x_Sekolah":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `Sekolah`, `Sekolah` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `v02_siswa`";
		$sWhereWrk = "";
