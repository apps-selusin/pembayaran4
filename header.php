...
<?php } ?>
<link href="phpcss/pre" rel="stylesheet" type="text/css">
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/pembayaran4.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
