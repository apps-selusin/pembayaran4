...
$t04_siswa_grid = NULL; // Initialize page object first

class ct04_siswa_grid extends ct04_siswa {
	...
	// Page object name
	var $PageObjName = 't04_siswa_grid';

	// Grid form hidden field names
	var $FormName = 'ft04_siswagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t04_siswa"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t03_kelas") {
			...
			if ($GLOBALS["t03_kelas"]->EventCancelled) $this->EventCancelled = TRUE;
		}
