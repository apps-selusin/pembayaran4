...
define("EWR_PROJECT_ID", "{0BB1DC5C-09DE-419A-9701-F3161918C007}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "pembayaran4_prj", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_pembayaran4", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '1xzbkmAkZVBydKfZ', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/pembayaran4_prj.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{0BB1DC5C-09DE-419A-9701-F3161918C007}", TRUE);
