...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_pembayaran4", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'KbYkKU6TRvmBjf7o', TRUE); // Random key for encryption
